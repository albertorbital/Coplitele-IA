# COPLITELE-IA - Secciones de la Web para Verificación de Clientes
Este documento recopila la estructura completa y el contenido textual de cada sección de la página web de **COPLITELE-IA** en sus tres idiomas (Español, Catalán e Inglés). Su finalidad es facilitar la lectura, revisión y validación de la información con los clientes.

---

## ÍNDICE
1. [Identidad Visual y Conceptos de Marca](#1-identidad-visual-y-conceptos-de-marca)
2. [Textos de Navegación y Generales](#2-textos-de-navegacion-y-generales)
3. [Vista: Inicio (Home)](#3-vista-inicio-home)
4. [Vista: Proyecto](#4-vista-proyecto)
5. [Vista: Impacto y Difusión](#5-vista-impacto-y-difusion)

---

## 1. IDENTIDAD VISUAL Y CONCEPTOS DE MARCA
El logotipo dinámico de la web incorpora tres ejes de desarrollo en su animación, cada uno asociado a un color y tres palabras conceptuales en inglés, además de un lema de soporte:

- **Eje Azul (Codiseño)**:
  - Palabras en logo: `Codesign`, `Learning`, `Itineraries`
  - Lema en cabecera: **Codiseño de aprendizaje flexible**
- **Eje Celeste (Personalización)**:
  - Palabras en logo: `Enhance`, `Personalized`, `Environments`
  - Lema en cabecera: **Itinerarios personalizados y agénticos**
- **Eje Verde (Tecnología)**:
  - Palabras en logo: `Technology`, `Inteligencia`, `Artificial`
  - Lema en cabecera: **Ambientes enriquecidos con Tecnología**

---

## 2. TEXTOS DE NAVEGACIÓN Y GENERALES
Estos textos corresponden al menú superior, botones de control de idioma, barra de búsqueda y pie de página.

### ID: `menu_inicio` (Opción Inicio del Menú)
- **Español (ES)**: Inicio
- **Catalán (CA)**: Inici
- **Inglés (EN)**: Home

### ID: `menu_proyecto` (Opción Proyecto del Menú)
- **Español (ES)**: Proyecto
- **Catalán (CA)**: Projecte
- **Inglés (EN)**: Project

### ID: `menu_impacto` (Opción Impacto y Difusión)
- **Español (ES)**: Impacto y Difusión
- **Catalán (CA)**: Impacte i Difusió
- **Inglés (EN)**: Impact & Dissemination

### ID: `search_placeholder` (Placeholders de búsqueda)
- **Español (ES)**: Buscar por título, autor o tag...
- **Catalán (CA)**: Cercar por títol, autor o etiqueta...
- **Inglés (EN)**: Search by title, author, or keyword...

### ID: `colab_title` (Título Colaboradores)
- **Español (ES)**: Con la colaboración y financiación de:
- **Catalán (CA)**: Amb la col·laboració i finançament de:
- **Inglés (EN)**: With the collaboration and funding of:

### ID: `footer_copy` (Copyright y Pie de página)
- **Español (ES)**: &copy; 2026 COPLITELE-IA. Proyecto financiado por el Ministerio español de Ciencia e Innovación, desarrollado por el GTE de la UIB y el IRIE.
- **Catalán (CA)**: &copy; 2026 COPLITELE-IA. Projecte finançat pel Ministeri espanyol de Ciència i Innovació, desenvolupat pel GTE de la UIB i l'IRIE.
- **Inglés (EN)**: &copy; 2026 COPLITELE-IA. Project funded by the Spanish Ministry of Science and Innovation, developed by the UIB GTE and IRIE.
...
- **Español (ES)**: Investigadores
- **Catalán (CA)**: Investigadors
- **Inglés (EN)**: Researchers

### ID: `stats_publicaciones` (Estadística 3: Publicaciones)
- **Español (ES)**: Publicaciones
- **Catalán (CA)**: Publicacions
- **Inglés (EN)**: Publications
...
- **Catalán (CA)**: Últimes notícies
- **Inglés (EN)**: Latest news

---

## 4. VISTA: PROYECTO
Esta vista se organiza bajo un menú interno con tres pestañas: Descripción, Objetivos y Miembros.

### Submenú Interno (Proyecto)
- **Descripción (`submenu_desc`)**: ES: "Descripción" | CA: "Descripció" | EN: "Description"
- **Objetivos (`submenu_obj`)**: ES: "Objetivos" | CA: "Objectius" | EN: "Objectives"
- **Miembros (`submenu_miembros`)**: ES: "Miembros" | CA: "Membres" | EN: "Members"

### 4.1. Sección: Descripción del Proyecto
#### ID: `project_pretitle` (Pretítulo de sección)
- **Español (ES)**: Conoce más
- **Catalán (CA)**: Coneix-ne més
- **Inglés (EN)**: Find out more

#### ID: `project_title` (Título de sección)
- **Español (ES)**: El Proyecto
- **Catalán (CA)**: El Projecte
- **Inglés (EN)**: The Project

#### ID: `project_what_is` (Pregunta de cabecera)
- **Español (ES)**: ¿Qué es COPLITELE-IA?
- **Catalán (CA)**: Què és COPLITELE-IA?
- **Inglés (EN)**: What is COPLITELE-IA?

#### ID: `project_what_is_p1` (Primer párrafo descriptivo)
- **Español (ES)**: **COPLITELE-IA** (Codiseño, Personalización y Tecnología en la Telecolaboración para el Aprendizaje de Lenguas con IA) es un proyecto de investigación financiado por el Ministerio de Ciencia e Innovación de España (Ref. PID2021-127836NB-I00).
- **Catalán (CA)**: **COPLITELE-IA** (Codisseny, Personalització i Tecnologia en la Telecolaboració per a l'Aprenentatge de Llengües amb IA) és un projecte d'investigació finançat pel Ministeri de Ciència i Innovació d'Espanya (Ref. PID2021-127836NB-I00).
- **Inglés (EN)**: **COPLITELE-IA** (Co-design, Personalization, and Technology in Telecollaboration for Language Learning with AI) is a research project funded by the Spanish Ministry of Science and Innovation (Ref. PID2021-127836NB-I00).

#### ID: `project_what_is_p2` (Segundo párrafo descriptivo)
- **Español (ES)**: El proyecto examina cómo los enfoques de codiseño participativo, combinados con herramientas de inteligencia artificial, pueden transformar las experiencias de telecolaboración interlingüística, especialmente en contextos de aprendizaje de lenguas extranjeras.
- **Catalán (CA)**: El projecte examina com els enfocaments de codisseny participatiu, combinats amb eines d'intel·ligència artificial, poden transformar les experiències de telecolaboració interlingüística, especialment en contextos d'aprenentatge de llengües estrangeres.
- **Inglés (EN)**: The project examines how participatory co-design approaches, combined with artificial intelligence tools, can transform interlingual telecollaboration experiences, especially in foreign language learning contexts.

#### ID: `project_what_is_p3` (Tercer párrafo descriptivo)
- **Español (ES)**: Nuestro enfoque integra la comunicación mediada por ordenador (CMC), el aprendizaje de lenguas asistido por ordenador (CALL) y las tecnologías emergentes de IA, incluidos modelos de lenguaje, análisis de sentimientos y sistemas de retroalimentación automatizada.
- **Catalán (CA)**: El nostre enfocament integra la comunicació mediada per ordinador (CMC), l'aprenentatge de llengües assistit per ordinador (CALL) i les tecnologies emergents d'IA, inclosos models de llenguatge, anàlisi de sentiments i sistemes de retroalimentació automatizada.
- **Inglés (EN)**: Our approach integrates computer-mediated communication (CMC), computer-assisted language learning (CALL), and emerging AI technologies, including language models, sentiment analysis, and automated feedback systems.

#### Ficha Técnica de Descripción (Metadatos)
- **Ref. Proyecto (`meta_ref`)**:
  - Etiqueta: ES: "Ref. Proyecto" | CA: "Ref. Projecte" | EN: "Project Ref"
  - Valor: `PID2021-127836NB-I00`
- **Duración (`meta_duracion`)**:
  - Etiqueta: ES: "Duración" | CA: "Durada" | EN: "Duration"
  - Valor: `2022-2025`
- **Institución Líder (`meta_lider`)**:
  - Etiqueta: ES: "Institución Líder" | CA: "Institució Líder" | EN: "Lead Institution"
  - Valor: `UIB (Universitat de les Illes Balears)`
- **Financiación (`meta_financiacion`)**:
  - Etiqueta: ES: "Financiación" | CA: "Finançament" | EN: "Funding"
  - Valor: `MCIN / AEI`

#### Tarjeta del Framework Metodológico (Visual)
- **Título (`framework_header`)**: ES/CA/EN: "COPLITELE-IA"
- **Subtítulo (`framework_subtitle`)**: ES: "Framework de investigación" | CA: "Framework d'investigació" | EN: "Research Framework"
- **Etiquetas fijas (Temáticas)**: `Codiseño` | `Telecolaboración` | `IA & NLP` | `CALL` | `Personalización` | `CMC`

### 4.2. Sección: Objetivos del Proyecto
**Título de la sección (`obj_title`)**: ES: "Objetivos del Proyecto" | CA: "Objectius del Projecte" | EN: "Project Objectives"

#### Objetivo 1 (Principal)
- **Título (`obj_1_title`)**:
  - ES: "Objetivo Principal" | CA: "Objectiu Principal" | EN: "Main Objective"
- **Descripción (`obj_1_desc`)**:
  - ES: "Investigar el impacto de la IA en la telecolaboración interlingüística, analizando cómo el codiseño mejora los procesos de aprendizaje de lenguas."
  - CA: "Investigar l'impacte de la IA en la telecolaboració interlingüística, analitzant com el codisseny millora els processos d'aprenentatge de llengües."
  - EN: "Investigate the impact of AI in interlingual telecollaboration, analyzing how co-design improves language learning processes."

#### Objetivo 2 (Innovación)
- **Título (`obj_2_title`)**:
  - ES: "Innovación" | CA: "Innovació" | EN: "Innovation"
- **Descripción (`obj_2_desc`)**:
  - ES: "Desarrollar herramientas de personalización adaptativa basadas en IA para entornos de aprendizaje de lenguas mediado por tecnología."
  - CA: "Desenvolupar eines de personalització adaptativa basades en IA per a entorns d'aprenentatge de llengües mediat per tecnologia."
  - EN: "Develop adaptive personalization tools based on AI for technology-mediated language learning environments."

#### Objetivo 3 (Alcance Internacional)
- **Título (`obj_3_title`)**:
  - ES: "Alcance Internacional" | CA: "Abast Internacional" | EN: "International Scope"
- **Descripción (`obj_3_desc`)**:
  - ES: "Colaboración con instituciones europeas y latinoamericanas para estudiar la comunicación mediada por ordenador en contextos plurilingüísticos."
  - CA: "Col·laboració amb institucions europees i llatinoamericanes per estudiar la comunicació mediada per ordinador en contextos plurilingües."
  - EN: "Collaboration with European and Latin American institutions to study computer-mediated communication in plurilingual contexts."

#### Objetivo 4 (Impacto Social)
- **Título (`obj_4_title`)**:
  - ES: "Impacto Social" | CA: "Impacte Social" | EN: "Social Impact"
- **Descripción (`obj_4_desc`)**:
  - ES: "Contribuir a la inclusión digital y educativa a través de soluciones tecnológicas accesibles y personalizadas."
  - CA: "Contribuir a la inclusió digital i educativa a través de solucions tecnològiques accessibles i personalitzades."
  - EN: "Contribute to digital and educational inclusion through accessible and personalized technological solutions."

### 4.3. Sección: Equipo de Investigadores (`equipo`)
**Título de la sección (`tab_equipo`)**: ES: "Equipo" | CA: "Equip" | EN: "Team"

#### Miembro: Dra. Maria Gómez (ID: `maria-gomez`)
- **Rol**:
  - ES: "Directora del Proyecto" | CA: "Directora del Projecte" | EN: "Project Director"
- **Biografía**:
...
- **Contacto**: Email: maria.gomez@uib.es | ORCID: 0000-0002-1823-9922

#### Miembro: Dr. Alberto Rodríguez (ID: `alberto-rodriguez`)
- **Rol**:
  - ES: "Investigador Principal" | CA: "Investigador Principal" | EN: "Lead Researcher"
- **Biografía**:
...
- **Contacto**: Email: alberto.rodriguez@uib.es | ORCID: 0000-0003-4902-8812

#### Miembro: Dr. Lucas Martínez (ID: `lucas-martinez`)
- **Rol**:
  - ES: "Investigador en IA" | CA: "Investigador en IA" | EN: "AI Researcher"
- **Biografía**:
...
- **Contacto**: Email: lucas.martinez@uib.es | ORCID: 0000-0001-9922-3844

#### Miembro: Sara Vidal (ID: `sara-vidal`)
- **Rol**:
  - ES: "Diseñadora UX / Facilitadora" | CA: "Dissenyadora UX / Facilitadora" | EN: "UX Designer / Facilitator"
- **Biografía**:
...
- **Contacto**: Email: sara.vidal@uib.es | ORCID: 0000-0002-3811-1922

---

## 5. VISTA: IMPACTO Y DIFUSIÓN
Contiene las noticias detalladas, actividades de transferencia docente, artículos de Zotero y recursos descargables.

### Submenú Interno (Impacto)
- **Noticias (`submenu_noticias`)**: ES: "Últimas noticias" | CA: "Últimes notícies" | EN: "Latest news"
- **Transferencia (`submenu_transferencia`)**: ES: "Transferencia" | CA: "Transferència" | EN: "Transfer"
- **Producción Científica (`submenu_publicaciones`)**: ES: "Producción científica" | CA: "Producció científica" | EN: "Scientific production"
- **Recursos (`submenu_recursos`)**: ES: "Recursos" | CA: "Recursos" | EN: "Resources"

### 5.1. Actividades de Transferencia (Detalle Completo)
**Título de la sección**: ES: "Actividades de Transferencia"
**Subtítulo de la sección (`trans_subtitle`)**: ES: "Actividades diseñadas para maximizar el impacto social y educativo de nuestra investigación, conectando la academia con la práctica docente y la sociedad." | CA: "Activitats dissenyades per maximitzar l'impacte social i educatiu de la nostra investigació, connectant l'acadèmia amb la pràctica docent i la societat." | EN: "Activities designed to maximize the social and educational impact of our research, connecting academia with teaching practice and society."

#### Actividad: Taller de Codiseño con Docentes (ID: `act-1`)
- **Tipo / Categoría**: ES: "Taller" | CA: "Taller" | EN: "Workshop"
- **Título Multilingüe**:
...
- **Datos**: Fecha: Marzo 2024 | Ubicación: UIB, Palma de Mallorca | Etiquetas: Codiseño, Formación Docente
- **Texto de Detalle Completo (Desplegado en Modal / Ficha Individual)**:
...
#### Actividad: Seminario Internacional: IA y CALL (ID: `act-2`)
- **Tipo / Categoría**: ES: "Seminario" | CA: "Seminari" | EN: "Seminar"
- **Título Multilingüe**:
...
- **Datos**: Fecha: Mayo 2024 | Ubicación: Online (Zoom) | Etiquetas: IA, CALL, Internacional
- **Texto de Detalle Completo (Desplegado en Modal / Ficha Individual)**:
...
#### Actividad: Demostración de Prototipo (ID: `act-3`)
- **Tipo / Categoría**: ES: "Demo" | CA: "Demo" | EN: "Demo"
- **Título Multilingüe**:
...
- **Datos**: Fecha: Octubre 2024 | Ubicación: UIB, Palma de Mallorca | Etiquetas: Tecnología, Demostración
- **Texto de Detalle Completo (Desplegado en Modal / Ficha Individual)**:
...
#### Actividad: Curso de Formación: NLP para Educadores (ID: `act-4`)
- **Tipo / Categoría**: ES: "Formación" | CA: "Formació" | EN: "Training"
- **Título Multilingüe**:
...
- **Datos**: Fecha: Enero 2025 | Ubicación: Online y presencial (UIB) | Etiquetas: NLP, Formación, Blended
- **Texto de Detalle Completo (Desplegado en Modal / Ficha Individual)**:
...
#### Actividad: Workshop: Diseño de Tareas Telecolaborativas (ID: `act-5`)
- **Tipo / Categoría**: ES: "Taller" | CA: "Taller" | EN: "Workshop"
- **Título Multilingüe**:
...
- **Datos**: Fecha: Marzo 2025 | Ubicación: UAH, Alcalá de Henares | Etiquetas: Diseño de Tareas, Telecolaboración
- **Texto de Detalle Completo (Desplegado en Modal / Ficha Individual)**:
...
#### Actividad: Jornada de Difusión de Resultados (ID: `act-6`)
- **Tipo / Categoría**: ES: "Difusión" | CA: "Difusió" | EN: "Dissemination"
- **Título Multilingüe**:
...
- **Datos**: Fecha: Junio 2025 | Ubicación: UIB, Palma de Mallorca | Etiquetas: Resultados, Difusión
- **Texto de Detalle Completo (Desplegado en Modal / Ficha Individual)**:
...
### 5.2. Producción Científica (Publicaciones vinculadas a Zotero)
**Título de la sección (`pub_title`)**: ES: "Producción Científica" | CA: "Producció Científica" | EN: "Scientific Production"
**Subtítulo de la sección (`pub_subtitle`)**: ES: "Accede a las publicaciones del proyecto sincronizadas con nuestra biblioteca de referencias de Zotero." | CA: "Accedeix a les publicacions del projecte sincronitzades amb la nostra biblioteca de referències de Zotero." | EN: "Access project publications synchronized with our Zotero reference library."

#### Publicación: Codiseño de entornos virtuales de aprendizaje personalizados mediante Inteligencia Artificial: Un enfoque cooperativo (ID: `pub-1`)
- **Tipo**: ES: "Artículos" | CA: "Articles" | EN: "Articles"
- **Cita Bibliográfica**: Gómez, M., & Rodríguez, A. (2025). Revista de Educación y Tecnología, 14(2), 120-138.
- **Título Multilingüe**:
...
- **Metadatos**: DOI: 10.1016/j.edutec.2025.101230 | Zotero Key: GOM2025
- **Palabras clave**: Codiseño, Inteligencia Artificial, Educación

#### Publicación: La perspectiva de la comunidad educativa en el diseño de herramientas de IA: Desafíos prácticos de la co-creación (ID: `pub-2`)
- **Tipo**: ES: "Artículos" | CA: "Articles" | EN: "Articles"
- **Cita Bibliográfica**: Martínez, L., Vidal, S., & Gómez, M. (2024). Pixel-Bit: Revista de Medios y Educación, 69, 45-78.
- **Título Multilingüe**:
...
- **Metadatos**: DOI: 10.12795/pixelbit.2024.10189 | Zotero Key: MAR2024
- **Palabras clave**: Co-creación, Tecnología, Usabilidad

#### Publicación: Tecnología Educativa y Personalización: Guía Práctica para el Codiseño de Aulas Inteligentes (ID: `pub-3`)
- **Tipo**: ES: "Publicaciones" | CA: "Publicacions" | EN: "Publications"
- **Cita Bibliográfica**: Gómez, M. (2024). Editorial UIB, Palma de Mallorca.
- **Título Multilingüe**:
...
- **Metadatos**: ISBN: 978-84-8384-498-3 | Zotero Key: GOM2024b
- **Palabras clave**: Manual, Codiseño, Aulas

#### Publicación: Inteligencia Artificial y Educación: Nuevos horizontes para el codiseño docente (ID: `pub-4`)
- **Tipo**: ES: "Publicaciones" | CA: "Publicacions" | EN: "Publications"
- **Cita Bibliográfica**: Rodríguez, A. (Ed.). (2025). Octaedro Editorial.
- **Título Multilingüe**:
...
- **Metadatos**: ISBN: 978-84-19023-88-2 | Zotero Key: ROD2025b
- **Palabras clave**: IA, Docencia, Innovación

#### Publicación: Dynamic Interface Generation for Personalized Learning: A Co-design Case Study (ID: `pub-5`)
- **Tipo**: ES: "Congresos" | CA: "Congressos" | EN: "Conferences"
- **Cita Bibliográfica**: Presented at International Conference on Educational Technology (ICET), Paris, 2024.
- **Título Multilingüe**:
...
- **Metadatos**: Zotero Key: ICET2024
- **Palabras clave**: UI, Automation, Agency

#### Publicación: El rol del codiseño en el desarrollo de asistentes virtuales inteligentes para secundaria (ID: `pub-6`)
- **Tipo**: ES: "Seminarios" | CA: "Seminaris" | EN: "Seminars"
- **Cita Bibliográfica**: Vidal, S. & Martínez, L. (2025). Ponencia en el Congreso Nacional de Investigación Educativa, Madrid.
- **Título Multilingüe**:
...
- **Metadatos**: Zotero Key: VID2025
- **Palabras clave**: Asistentes, Secundaria, Prototipado

### 5.3. Recursos del Proyecto (Descargables)
**Título de la sección (`rec_title`)**: ES: "Recursos del Proyecto" | CA: "Recursos del Projecte" | EN: "Project Resources"
**Subtítulo de la sección (`rec_subtitle`)**: ES: "Descarga materiales pedagógicos y herramientas de codiseño desarrolladas durante la investigación." | CA: "Descarrega materials pedagògics i eines de codisseny desenvolupades durant la investigació." | EN: "Download pedagogical materials and co-design tools developed during the research."

#### Recurso: Guía de Codiseño en Tecnología Educativa
- **Categoría**: Manual Metodológico
- **Descripción (ES - General)**: Un compendio de dinámicas, fichas imprimibles y directrices prácticas para planificar y llevar a cabo talleres de codiseño tecnológico con profesorado y estudiantes.
- **Botón de Descarga (`rec_btn_pdf`)**: ES: "Descargar PDF (4.8 MB)" | CA: "Descarregar PDF (4.8 MB)" | EN: "Download PDF (4.8 MB)"

#### Recurso: Fichas de Explicabilidad Algorítmica
- **Categoría**: Plantillas Didácticas
- **Descripción (ES - General)**: Materiales didácticos de apoyo para trabajar la soberanía y comprensión del dato escolar con alumnos de secundaria y bachillerato en sesiones presenciales.
- **Botón de Descarga (`rec_btn_zip`)**: ES: "Descargar Plantillas (Zip, 12 MB)" | CA: "Descarregar Plantilles (Zip, 12 MB)" | EN: "Download Templates (Zip, 12 MB)"

#### Recurso: Módulo de Personalización Soberana
- **Categoría**: Código Abierto
- **Descripción (ES - General)**: Accede al repositorio público del prototipo funcional que integra las librerías de personalización algorítmica parametrizable con interfaces web adaptables.
- **Botón de Descarga (`rec_btn_git`)**: ES: "Ver Repositorio GitHub" | CA: "Veure Repositori GitHub" | EN: "View GitHub Repository"
